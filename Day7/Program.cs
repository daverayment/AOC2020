...
namespace Day7
{
    class Program
    {
        ...
        static void Main(string[] _)
        {
            ...
            foreach (string line in RawInput.Split(Environment.NewLine))
            {
        ...
        static long CountChildBags(string parentBag, Dictionary<string, List<Bag>> bags)
        {
            long currentCount = 0;
        ...
        static void AddBags(string childBag, Dictionary<string, List<string>> bags, HashSet<string> containers)
        {
            if (bags.ContainsKey(childBag))
            {
        ...
        static readonly string RawInput =
